...
const Canregister = () => {
    ...
    const backend_URL = `${import.meta.env.VITE_BACKEND_URL}canregister`;
    const initalState = {
        username: "",
        email: "",
        mobile: "",
    ...
    const [registeredData, setRegisteredData] = useState(initalState);
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        hookHandleSubmit(registeredData,backend_URL,'/login');
    };

    return (
        <>
            <div className="utility-page-wrap">
                <div className="utility-page-content-password w-password-page w-form">
                    <form
                        id="registerform"
                    ...
                    >
                        ...
                        <div className="_2-buttons-wrapper">
                            <div className="button-spacer">
                                <a href="#" className="button-primary full-width-mobile w-button">Candidate</a>
                            </div>
                            <a href="/employer/register" className="button-secondary w-button">Employer</a>
                        </div>
                        <h2></h2>
                        <input
                            type="text"
                        ...
                        <input
                            ...
                            id="mobile"
                            required
                            value={registeredData.mobile}
                            onChange={handleChange}
                        />
                        <div className="input password w-password-page w-input eyeInput">
                            <input type={passIntype} id="eyeInputField" placeholder="Password" minlength="8" name="password" value={registeredData.password} onChange={handleChange} required/>
                        ...
                        <div className="input password w-password-page w-input eyeInput">
                            <input type={cPassintype} placeholder="Confirm your password" id="eyeInputField2" minlength="8" name="cpassword" value={registeredData.cpassword} onChange={handleChange} required/>
