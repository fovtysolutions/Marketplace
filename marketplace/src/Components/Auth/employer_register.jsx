...
const Empregister = () => {
    ...
    const backend_URL = `${import.meta.env.VITE_BACKEND_URL}empregister`;
    const initalState = {
        username: "",
        weburl: "",
        email: "",
                    ...
                    >
                        ...
                        <div className="_2-buttons-wrapper">
                            <div className="button-spacer">
                                <a href="/candidate/register" className="button-secondary w-button">Candidate</a>
                            </div>
                            <a href="#" className="button-primary full-width-mobile w-button">Employer</a>
                        </div>
                        <h2></h2>
                        <input
                            type="text"
