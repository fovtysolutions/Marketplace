...
import CategorySwiper from "../hooks/CategorySwiper";
...
const RightSideVendor = ({ data }) => {
    ...
    const itemsPerPage = 4; // Change this value to adjust items per page
            ...
            <div className='gridviewven'>
                ...
                <div className="catandview">
                    <div className="catsuggestbox">
                        <CategorySwiper allcategories={allcategories} changeCategory={changeCategory} />
                    </div>
                ...
                {isVisibleGrid && (
                    <div className="carouselven">
                        ...
                        <div className="adpanel">
                            <img className="adpanelvenr" src="https://media.istockphoto.com/id/1124641253/photo/blank-billboard-above-the-escalator.jpg?s=612x612&w=0&k=20&c=ZFpZEPSqf-iMNTRORPvOzKsj8Ae5i8IFC7up3J-Mq40=" alt="ad" />
                            <img className="adpanelvenr" src="https://media.istockphoto.com/id/1365276338/photo/blank-billboard-on-the-railroad-station.jpg?s=612x612&w=0&k=20&c=qSHIAToXS6cLUCYWagz5vJ971aEoU-SXhb5Br_ytgT4=" alt="ad" />
                        </div>
                    </div>
                )}
            </div>
