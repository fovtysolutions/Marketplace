    ...
    return (
        <>
          <div id="resumePage" className={`phase-container ${slideshow === 7 ? 'slide-left' : ''}`}  style={{ display: showthis === 1 ? 'block' : 'none' }}>
            <div className="upload-resume-container form-container canwidth"  id="loadingnone">
              <form id="offer-main-form">
                <div className="form-group text-center" onClick={openFile}>
                    <input ref={fileInputRef} type="file"  hidden name="uploaded" id="uploaded" onChange={handleChange} />
                    <div className="upload-resume" id="btn-offer-main">
                      <span>
                        ...
                        Upload Resume
                      <span className="format">format: pdf, doc, excel, word, txt</span>
                    </div>
                    <div 
            ...
            <div id="loaderresume" className="loader candisplay"></div>
            <div className="canred" id="alertresume"></div>
          </div>
        </>
    );
};
