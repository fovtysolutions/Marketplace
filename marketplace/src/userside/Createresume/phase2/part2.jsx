    ...
    return (
        <>
            <div>
                ...
                />
                <div class="small-images" id="small_images">
                    {mejorFiles.map((fileObj, index) => (
                        <div class="individual-img canphase2relative" id="imageContainer" key={index}>
                        <img
                        ...
                        />
                            <svg onClick={() => handleDeleteFile(index)} class="cancel-icon" id="remove_image" xmlns="http://www.w3.org/2000/svg" height="16" width="12" viewBox="0 0 384 512">
